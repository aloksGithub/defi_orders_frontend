...
export interface INonFungiblePositionsManagerInterface extends utils.Interface {
  functions: {
...
export interface INonFungiblePositionsManager extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: INonFungiblePositionsManagerInterface;
